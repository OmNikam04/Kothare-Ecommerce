...
export const getProduct =
  ...
  async (dispatch) => {
    try {
      ...
      let link = `${process.env.REACT_APP_BACKEND_URL}/products?keyword=${keyword}&page=${currentPage}&price[gte]=${price[0]}&price[lte]=${price[1]}&ratings[gte]=${ratings}`;

      if (category) {
        link = `${process.env.REACT_APP_BACKEND_URL}/products?keyword=${keyword}&page=${currentPage}&price[gte]=${price[0]}&price[lte]=${price[1]}&category=${category}&ratings[gte]=${ratings}`;
      }
