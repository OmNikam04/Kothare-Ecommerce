...
export const register = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(`${BACKEND_URL}/register`, userData, config);
...
export const updateProfile = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`${BACKEND_URL}/me/update`, userData, config);
...
export const forgotPassword = (email) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(`${BACKEND_URL}/password/forgot`, email, config);
